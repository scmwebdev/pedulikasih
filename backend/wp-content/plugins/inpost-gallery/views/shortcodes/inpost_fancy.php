...
<?php
wp_enqueue_style("fancybox", InpostGallery::get_application_uri() . 'js/sliders/fancybox/jquery.fancybox-1.3.4.css');
wp_enqueue_script('fancybox', InpostGallery::get_application_uri() . 'js/sliders/fancybox/jquery.fancybox-1.3.4.pack.js', array('jquery'));
wp_enqueue_script('mousewheel', InpostGallery::get_application_uri() . 'js/jquery.mousewheel-3.0.6.pack.js', array('jquery'));
wp_enqueue_script("easing", InpostGallery::get_application_uri() . 'js/jquery.easing.1.3.min.js', array('jquery'));
//***
